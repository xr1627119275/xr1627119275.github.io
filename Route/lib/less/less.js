            ...
            module.exports = function (environment) {
                ...
                ImportManager.prototype.push = function (path, tryAppendLessExtension, currentFileInfo, importOptions, callback) {
                    ...
                    var loadFileCallback = function (loadedFile) {
                        ...
                        //
                        // Examples:
                        // - If path of imported file is 'module/nav/content.less' and rootpath is 'less/',
...
//      The chunks are stored in the `chunks` var.less,
                ...
                return {
                    ...
                    parsers: parsers = {
                        ...
                        entities: {
                            ...
                            // A variable entity useing the protective {} e.g. @{var.less}
                        ...
                        rule: function (tryAnonymous) {
                            var name, value, startOfRule = parserInput.i, c = parserInput.currentChar(), important,
                                merge, isVariable;
